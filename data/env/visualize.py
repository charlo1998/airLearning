    ...
    with open(file, 'r') as f:
        ...
        if 'loop_rate_list' in line: #found the first list
            ...
            while 'take_action_list' not in line: #continue reading until start of next list
                ...
                line = f.readline()
            print("finished reading loop rates")
...
def plot(data="C:/Users/charl/workspace/airlearning/airlearning-rl/data/env/env_log.txt"):
    print("reading data")
    take_action_list, clct_state_list, loop_rate = Parse(data)
    print('finished reading data')
    print(f"total time elapsed iterating: {sum(loop_rate)}")
    print("smoothing data")
    avg_actions, avg_collect, avg_loop = SmoothData(take_action_list, clct_state_list, loop_rate, 500)
